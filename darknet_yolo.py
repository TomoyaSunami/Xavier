...
def execute_cmdline(argv):
    ...
    for opt, arg in opts:
        if opt == '-h':
            ...
            zed_id = int(arg)
    launch_yolo_env(thresh, darknet_path, config_path, weight_path, meta_path, svo_path, zed_id)



def launch_yolo_env(thresh, darknet_path, config_path, weight_path, meta_path, svo_path, zed_id):
